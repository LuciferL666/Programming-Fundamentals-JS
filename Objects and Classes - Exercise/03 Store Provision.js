...
// for(let p = 0; p < available.length; p+=2){
// let currentProduct = available[p];

// storedProducts[currentProduct] = Number(available[p+1]);
// }
// for(let y = 0; y < delivery.length; y+=2){
//     let currentProduct = delivery[y];
//     if(!storedProducts.hasOwnProperty(currentProduct)){
//         storedProducts[currentProduct] = 0
//     }
//     storedProducts[currentProduct] += Number(delivery[y+1])
// }
